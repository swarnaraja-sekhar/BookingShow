...
const SeatLayout = () => {
  ...
  const handleSeatClick = (seatId) => {
    ...
    if(!selectedSeats.includes(seatId) && selectedSeats.length > 4){
      return toast('you csn select only 5 seats')
    }
          ...
          <div className='flex flex-wrap items-center justify-center gap-2'>
            {Array.from({length:count},(_,i)=>{
              ...
              return (
                ...
                rounded border border-primary/60 cursor-pointer ${selectedSeats.includes(seatId) && 
                  "br-primary text-white"
                }`}>
                    {seatId}
                </button>
              );
    ...
    <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
      ...
      {/* Seats layout */}
          <div className='relative flex-1 flex flex-col items-center max-md:mt-16'>
            ...
            <h1 className='text-2xl font-semibold md-4'>
              Select your seat
            </h1>
              <img src={assets.screenImage} alt="screen"/>
              <p className='text-gray-400 text-sm mb-0'>SCREEN SIDE</p>

            <div className='flex flex-col items-center mt-10 text-ms  text-gray-300'>
            ...
            py-3 text-sm  bg-primary hover:br-primary-dull hover:bg-red-500 transition rounded-full font-medium 

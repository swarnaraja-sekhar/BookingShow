...
const HeroSection = () => {
  ...
  return (
    ...
    lg:px-36 bg-[url("/src/assets/backgroundImage.png")] bg-cover bg-center h-screen'>
            ...
            max-w-110'>Guadians <br />of the Galaxy</h1>

        <div className='flex items-center gap-4 text-gray-300'>
            <span>Action | Advanture | Scifi</span>
        ...
        <p className='max w-md text-gray-300'> In a post-apocalyptic world where cities ride on wheels
            and cosume each other to survive, two people meet in london and try to stop a comspiracy.
        </p>
                 
        <button onClick={()=>navigate('/movies')} className='flex items-center gap-1 px-6 py-3 text-sm bg-primary hover:bg-primary-dull
         transition rounded-full font-medium cursor-pointer bg-red-500'> 
            Explore movies

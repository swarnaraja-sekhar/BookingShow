    ...
    <div id="dateSelect" className='pt-30'>
        ...
        border border-primary/20 rounded-lg'>
            ...
            <div>
                ...
                <div className='flex items-center gap-9 text-sm mt-5'>
                    <ChevronLeftIcon width={28}  />

                    <span className='grid grid-cols-3 md:flex flex-wrap md:max-w-lg gap-8'>

                        {Object.keys(dateTime).map((date)=>(
                            <button onClick={() => setSelected(date)} 
                            key={date} className={`flex flex-col items-center justify-center 
                            h-14 w-14 aspect-square rounded cursor-pointer border-red-400 ${selected === date ? "bg-primary text-white" :
                    ...
                    <ChevronRightIcon width={28} />
                        ...
                        transition-all cursor-pointer bg-red-700'>Book Now
                        </button>
        </div>
